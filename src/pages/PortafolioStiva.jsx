...
const PortfolioStiva = () => {
    ...
    <SEO
        title={t("portfolio-stiva.seo.title")}
        description={t("portfolio-stiva.seo.description")}
    />
    <div className="w-[95%] mx-auto">
        ...
        <motion.p
            ...
            transition={{ duration: 0.7 }}
        >
            {t("portfolio-stiva.text1")}
            <br></br>
            <br></br>
            {t("portfolio-stiva.text2")}
            <br></br>
            <br></br>
            {t("portfolio-stiva.text3")}
            <br></br>
            <br></br>
            {t("portfolio-stiva.text4")}
            <br></br>
            <br></br>
            {t("portfolio-stiva.text5")}
        </motion.p>
        ...
        <motion.h2
            ...
            transition={{ duration: 0.7 }}
        >
            {t("portfolio-stiva.disclaimer-title")}
        </motion.h2>
        <motion.p
            className="text-base lg:text-base"
            initial={{ opacity: 0, y: 30 }}
            ...
            transition={{ duration: 0.7 }}
        >
            {t("portfolio-stiva.disclaimer-text")}
        </motion.p>
        <motion.h2
            ...
            transition={{ duration: 0.7 }}
        >
            {t("portfolio-stiva.otros-proyectos")}
        </motion.h2>
        <PotafolioStivaSlier/>
